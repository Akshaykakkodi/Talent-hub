    ...
    <div class="row no-gutters shuffle-wrapper">
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="images/steve-johnson-5MTf9XyVVgM-unsplash.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
            <a href="product_shop.php" class="text-white h4">Purchase</a>
            <a href="product_shop.php"><i class="ti-link icon-xs text-white"></i></a>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="images/steve-johnson-3Sf_G9m0gcQ-unsplash.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
          <a href="product_shop.php" class="text-white h4">Purchase</a>
          <a href="product_shop.php"><i class="ti-link icon-xs text-white"></i></a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="images/europeana-5TK1F5VfdIk-unsplash.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
          <a href="product_shop.php" class="text-white h4">Purchase</a>
          <a href="product_shop.php"><i class="ti-link icon-xs text-white"></i></a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="images/dan-farrell-fT49QnFucQ8-unsplash.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
          <a href="product_shop.php" class="text-white h4">Purchase</a>
          <a href="product_shop.php"><i class="ti-link icon-xs text-white"></i></a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="images/diogo-nunes-Wa9ilX9XYOI-unsplash.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
          <a href="product_shop.php" class="text-white h4">Purchase</a>
            <a href="product_shop.php"><i class="ti-link icon-xs text-white"></i></a>
          </div>
...
<!-- <section class="section">
  <div class="container">
    <div class="row">
      <div class="col-lg-10 mx-auto text-center">
        <h2>Our Products</h2>
        <p>Check out trending products</p>
        <div class="section-border"></div>
      </div>
    </div>
