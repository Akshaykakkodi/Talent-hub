...
session_start();
$data2= $_SESSION['log'];
$data= mysqli_query($con,"select * from product_tb join student_registration on product_tb.login_id=student_registration.login_id where product_tb.status='1' and category='painting' ");
