...
session_start();
$data2= $_SESSION['log'];
$data= mysqli_query($con,"select * from product_tb join student_registration on product_tb.login_id=student_registration.login_id where product_tb.status='1' and category='handicraft' ");
      ...
      <table class="table table-hover">
        ...
        <?php
          ...
          <tr>
            ...
            <td><a href="su_chat.php?id=<?php echo $row['login_id'] ?>">Buy</a></td>
            <td><a href="feedback.php?id=<?php echo $row['product_id'] ?>">Add feedback</a></td>
