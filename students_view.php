...
$data= mysqli_query($con,"select * from student_registration");
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">Students</h1>
      </div>
    </div>
  </div>
</section>
      ...
      <table class="table table-hover">
        ...
        $count=0;
          ...
          <tr>
           ...
           <?php if(  $row['status']==0 ){ ?>
            <td><a href="student_approve.php?id=<?php echo $row['login_id'] ?>">Pending</a></td>
           <?php } else{ ?> <td>Approved</td> <?php } ?>
            <td><a href="student_delete.php?id=<?php echo $row['login_id'] ?>">Delete/Block</a></td>
          </tr>
         <?php
          }
         ?>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 text-center text-md-left">
          <p class="text-light mb-0">Copyright &copy; 2019 a theme by <a class="text-gradient-primary" href="https://themefisher.com">talenthub.com</a>
          </p>
        </div>
        <div class="col-md-6">
