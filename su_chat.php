...
if(isset($_POST['sub'])){
$ch= $_POST['chat'];
mysqli_query($con,"insert into su_chat (user_id,student_id,message)value('$data2','$id','$ch')");
header('location:su_chat2.php');
...
<section class="section">
  <div class="container">
    <div class="row">
      ...
      <form method="post">
      <textarea name="chat"  cols="50" rows="5" class="form-control mb-4 px-0" placeholder="Write message here" required></textarea><br>
