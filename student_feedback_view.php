...
session_start();
$data2= $_SESSION['log'];
$data= mysqli_query($con,"select * from feedback_tb join  product_tb on feedback_tb.product_id=product_tb.product_id  join public_registration on feedback_tb.login_id=public_registration.login_id where product_tb.login_id='$data2'");
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">Feedback by users</h1>
      </div>
    </div>
  </div>
</section>
