...
session_start();
$data2= $_SESSION['log'];
$data= mysqli_query($con,"select * from su_chat join student_registration on student_registration.login_id=su_chat.student_id where user_id='$data2'");

// if(isset($_POST['send'])){
//   $mg= $_POST['rep'];
  
//   mysqli_query($con,"insert into as_chat (reply)value('$mg') ");
// }
      ...
      <table class="table table-hover">
        ...
        <?php
          ...
          <tr>
            ...
            <td> <button class="btn btn-primary" name="send" type="submit"><a style="color:white" href="as_chat2.php?id=<?php echo $row['chat_id'] ?>">Reply</a></button></td></td>
            <form method="post">
