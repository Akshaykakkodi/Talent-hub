...
session_start();
$data2= $_SESSION['log'];
$data= mysqli_query($con,"select * from feedback_tb join public_registration on feedback_tb.login_id=public_registration.login_id  join product_tb on feedback_tb.product_id=product_tb.product_id");
