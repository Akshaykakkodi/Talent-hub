...
session_start();
$data2= $_SESSION['log'];
$data= mysqli_query($con,"select * from student_registration join login_tb on student_registration.login_id=login_tb.login_id  where login_tb.login_id='$data2'");
      ...
      <table class="table table-hover">
        ...
        <?php
          ...
          <tr>
            ...
            <td><a href="student_edit.php?id=<?php echo $row['login_id'] ?>">edit</a></td>
          </tr>
         <?php
          }
         ?>
